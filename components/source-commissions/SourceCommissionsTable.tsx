...
import { CommissionBookingSource } from "@/actions/sourceCommissionActions";
import DeleteSourceCommissionButton from "@/components/source-commissions/DeleteSourceCommissionButton";
import {
  Badge,
  Table,
  TableBody,
...
type SourceCommissionsTableProps = {
  rows: CommissionBookingSource[];
  offset: number;
  emptyMessage: string;
};
...
export default function SourceCommissionsTable({
  rows,
  offset,
  emptyMessage,
}: SourceCommissionsTableProps) {
  return (
                ...
                >
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      <Link
                        href={`/admin/source-commissions/${row.id}`}
                      ...
                      {row.isActive && (
                        <DeleteSourceCommissionButton id={row.id} />
                      )}
                    </div>
                  </TableCell>
                </TableRow>
