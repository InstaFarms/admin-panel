...
import { AmenityData } from "@/utils/types";
  ...
  return (
    <>
      <td className="px-3 py-3 align-middle">
        <span className="font-medium text-gray-900 dark:text-gray-100" id={`amenity-title-${data.id}`}>
          {data.name || "--"}
        </span>
      </td>
      <td className="px-3 py-3 align-middle">
...
export default function SortableAmenityRow(props: SortableAmenityRowProps) {
  ...
  return (
    <tr ref={setNodeRef} style={style} className="border-b border-gray-200 align-middle dark:border-gray-700">
      ...
      <AmenityRowContent data={props.data} removeAmenity={props.removeAmenity} />
    </tr>
  );
}
