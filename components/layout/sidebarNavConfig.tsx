    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            href: "/admin/instafarm-content/faqs/all-location",
            label: "Location FAQs",
            icon: FaQuora,
            permissionKey: "INSTAFARMS_SPECIFIC_DATA",
            activeMatch: "/admin/instafarm-content/faqs/all-location",
          },
          {
            href: "/admin/instafarm-content/faqs/all-collection",
            label: "Collections FAQs",
            icon: FaQuora,
            permissionKey: "INSTAFARMS_SPECIFIC_DATA",
            activeMatch: "/admin/instafarm-content/faqs/all-collection",
          },
          {
            href: "/admin/instafarm-content/faqs/customer-care",
            label: "Customer Care FAQs",
            icon: FaQuora,
            permissionKey: "INSTAFARMS_SPECIFIC_DATA",
            activeMatch: "/admin/instafarm-content/faqs/customer-care",
          },
        ],
      },
    ],
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            href: "/admin/mago-content/faqs/all-location",
            label: "Location FAQs",
            icon: FaQuora,
            permissionKey: "INSTAFARMS_SPECIFIC_DATA",
            activeMatch: "/admin/mago-content/faqs/all-location",
          },
          {
            href: "/admin/mago-content/faqs/all-collection",
            label: "Collections FAQs",
            icon: FaQuora,
            permissionKey: "INSTAFARMS_SPECIFIC_DATA",
            activeMatch: "/admin/mago-content/faqs/all-collection",
          },
          {
            href: "/admin/mago-content/faqs/customer-care",
            label: "Customer Care FAQs",
            icon: FaQuora,
            permissionKey: "INSTAFARMS_SPECIFIC_DATA",
            activeMatch: "/admin/mago-content/faqs/customer-care",
          },
        ],
      },
    ],
