...
import { BREADCRUMBS } from "@/constants/customers";
...
const EDIT_FORM_ID = "instafarms-customer-edit-form";
...
export default async function Page({ params, searchParams }: ServerPageProps) {
  ...
  const detailsHref = `/admin/Instafarms-customer/${customer.id}?tab=details`;
  const bookingsHref = `/admin/Instafarms-customer/${customer.id}?tab=bookings`;
  const favoritesHref = `/admin/Instafarms-customer/${customer.id}?tab=favorites`;

  return (
    <div className="flex w-full flex-col">
      <Card className="w-full bg-white dark:bg-gray-800">
        <div className="flex flex-col gap-5">
          <PageBreadcrumb items={BREADCRUMBS.edit} />
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Badge color="info">Instafarms</Badge>
            ...
            <div className="flex flex-wrap items-center gap-3">
              {activeTab === "details" ? (
                <>
                  ...
                  <DeleteCustomerButton id={customer.id} brandName={CUSTOMER_BRANDS.INSTAFARMS} />
                </>
              ) : null}
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          >
            <>
              <section className="relative overflow-hidden rounded-[32px] border border-slate-200/80 bg-gradient-to-br from-slate-100 via-white to-slate-100 px-6 py-7 shadow-sm dark:border-gray-700 dark:from-[#111827] dark:via-[#131c2f] dark:to-[#0f172a] xl:px-7">
                ...
                <div className="relative grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px] xl:items-end">
                  <div className="space-y-5">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      <Badge color="info">Instafarms Customer</Badge>
                      {customer.gender ? <Badge color="gray">{customer.gender}</Badge> : null}
              ...
              <CustomerEditor data={customer} brandName={CUSTOMER_BRANDS.INSTAFARMS} formId={EDIT_FORM_ID} />
            </>
          </CustomerDetailTabs>
        </div>
      </Card>
