...
import { SEARCH_KEYS, BREADCRUMBS, TABLE_COLUMNS } from "@/constants/customers";
      ...
      <Card className="w-full bg-white dark:bg-gray-800">
        <div className="flex w-full flex-col gap-2">
          <h5 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
            Instafarms Customers
          </h5>
          <div className="flex w-full flex-col gap-3 pb-3 sm:flex-row sm:items-center sm:justify-between">
            <PageBreadcrumb items={BREADCRUMBS.list} className="w-full shrink-0 sm:w-auto" />
            <div className="flex w-full shrink-0 flex-row items-center justify-end gap-3 sm:w-auto">
              ...
              <Link href="/admin/Instafarms-customer/create" className="shrink-0">
                <Button>New</Button>
              </Link>
            </div>
          </div>
                    ...
                    <TableRow key={user.id} className="bg-white dark:border-gray-700 dark:bg-gray-800">
                      ...
                      <TableCell className="font-medium whitespace-nowrap text-gray-900 dark:text-white">
                        <div className="max-w-[150px] truncate sm:max-w-none">
                          <Link
                            href={`/admin/Instafarms-customer/${user.id}`}
                      ...
                      <TableCell>
                        <Link href={`/admin/Instafarms-customer/${user.id}`} title="Edit">
