...
const INSTAFARMS_BREADCRUMBS = {
    list: [
        { href: "/", label: "Home" },
        { href: "/admin", label: "Admin" },
        { href: "/admin/instafarms-proposals", label: "Instafarms Proposals" },
    ],
};

export default async function InstafarmsProposalsPage() {
    let proposals: any[] = [];
    try {
        proposals = await getProposals({ brandName: CUSTOMER_BRANDS.INSTAFARMS });
    } catch (err) {
