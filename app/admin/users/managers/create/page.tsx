...
import ManagerEditor from "../[id]/UserEditor";
import PageBreadcrumb from "@/components/PageBreadcrumb";
import { USERS_BREADCRUMBS } from "@/constants/users";
import { useState } from "react";

const CREATE_FORM_ID = "manager-create-form";
    ...
    <div className="flex w-full flex-col">
      <Card className="w-full bg-white dark:bg-gray-800">
        <div className="flex flex-col gap-5">
          <PageBreadcrumb items={USERS_BREADCRUMBS.managers.create} />
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500 dark:text-slate-300">
                Add contact details and property assignments for a new manager profile.
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              <Button
            ...
            <div className="relative grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px] xl:items-end">
              <div className="space-y-5">
                <div className="space-y-3">
                  ...
                  <h2 className="text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">New Manager</h2>
                </div>
                <div className="flex flex-wrap items-center gap-3">
                  <Badge color="info">Manager</Badge>
          ...
          <section className="rounded-[28px] border border-slate-200/80 bg-slate-100/90 shadow-sm dark:border-gray-700 dark:bg-gray-900/90">
            <div className="border-b border-slate-200/80 bg-white/60 px-5 py-4 dark:border-gray-700 dark:bg-white/[0.03]">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                {activeTab === "details" ? "Manager Details" : "Assigned Properties"}
              </h2>
              <p className="mt-1 text-sm text-gray-500 dark:text-slate-300">
                {activeTab === "details"
                  ? "Enter the manager profile details used across property assignments and operations."
                  : "Search, add, remove, and review the properties that should be assigned to this manager."}
              </p>
            </div>
            <div className="p-5">
              <ManagerEditor formId={CREATE_FORM_ID} mode={activeTab === "details" ? "details" : "properties"} />
            </div>
          </section>
        </div>
      </Card>
