/**
 * Instafarms Offline bookings list: paginated table with search and filters.
...
export default async function Page({ searchParams }: ServerPageProps) {
  ...
  const result = await getAdminBookingsList({
    ...
    // — skip"), so this is what actually scopes the list apart from its Mago
    // sibling — both ran the identical query before (QA #121).
