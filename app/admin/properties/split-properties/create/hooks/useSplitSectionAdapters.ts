...
export function useSplitSectionAdapters(input: {
  propertyTypes: any[];
  detailForm: any;
  addressForm: any;
  ...
  return useMemo(
    ...
    [propertyTypes, detailForm, addressForm, dayWiseForm, areaData, cityData, stateData, othersOverride, specialDatesOverride, galleryOverride, coverPhotosOverride, parentPropertyData, joditConfig, setDetailForm, setAddressForm, setDayWiseForm, setDetailOverride, setAddressOverride, setOthersOverride, setSpecialDatesOverride, setGalleryOverride, setCoverPhotosOverride]
  );
}
